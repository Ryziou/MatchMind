    ...
    <AppShell>
      <section className="hero-panel">
        ...
        <p className="hero-copy m-0">
          ...
          (RAG): upload a CV, add a job URL or description, and produce a tailored application
          package from the most relevant sections of that CV.
        </p>
      </section>
      ...
      <section className="workspace-panel">
        ...
        <p className="section-subtitle m-0 line-height-3">
          ...
          output, and a clean end-to-end product flow from upload to tailored PDFs.
        </p>
      </section>
    </AppShell>
  );
